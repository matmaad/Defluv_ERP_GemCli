...
export default function SettingsClient({ currentEmail, userName }: Props) {
  ...
  return (
    <div className="flex-1 p-8 space-y-12 bg-gray-50 overflow-y-auto font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-[#0a2d4d]">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 space-y-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-sm font-black uppercase tracking-widest text-[#0a2d4d]">Actualizar Correo</h3>
            </div>
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 space-y-6">
            <div className="flex items-center gap-3 text-[#0a2d4d]">
              ...
              <h3 className="text-sm font-black uppercase tracking-widest text-[#0a2d4d]">Cambiar Contraseña</h3>
            </div>
