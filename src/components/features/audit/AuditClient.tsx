        ...
        <div className="flex-1 p-8 space-y-6 overflow-y-auto">
           ...
           <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm grid grid-cols-1 md:grid-cols-5 gap-6 items-end">
              ...
              <div className="space-y-1.5">
                 ...
                 <input type="date" value={fechaHasta} onChange={(e) => setFechaHasta(e.target.value)} className="w-full bg-gray-50 border border-gray-100 rounded-xl px-4 py-2.5 text-xs font-bold text-zinc-900 outline-none focus:ring-2 focus:ring-blue-500/20" />
              </div>
              <div className="space-y-1.5">
           ...
           <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
              <div className="overflow-x-auto">
                 <table className="w-full text-left border-collapse text-[#0a2d4d] table-fixed min-w-[1000px]">
                    <thead>
                       <tr className="bg-gray-50/50 border-b border-gray-100 uppercase text-gray-400 font-black text-[10px] tracking-widest">
                    ...
                    <tbody className="divide-y divide-gray-50 font-medium">
                       ...
                       {filteredLogs.length === 0 && (
                         <tr><td colSpan={5} className="px-8 py-12 text-center text-gray-400 text-sm font-black uppercase tracking-widest">Sin registros de auditoría.</td></tr>
                       )}
                    </tbody>
                 </table>
              </div>
