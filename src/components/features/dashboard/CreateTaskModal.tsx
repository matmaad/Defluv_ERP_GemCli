      ...
      <div className="bg-white w-full max-w-xl rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
          <div className="flex items-center gap-3">
             ...
             <div>
                <h3 className="text-sm font-bold text-[#0a2d4d] uppercase tracking-widest">Crear Nueva Tarea</h3>
        ...
        {success ? (
          <div className="p-20 flex flex-col items-center justify-center text-center space-y-4">
             ...
             <h4 className="text-xl font-bold text-[#0a2d4d]">¡Tarea Asignada!</h4>
          ...
          <form onSubmit={handleCreate} className="p-8 space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <label 
                  htmlFor="task-file"
                  className="flex items-center gap-3 w-full px-4 py-3 border-2 border-dashed border-gray-200 rounded-xl bg-gray-50 cursor-pointer group-hover:border-blue-400 transition-all"
                >
